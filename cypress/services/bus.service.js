...
export class Bus extends Rest {
    ...
    static listar_paradas() {
        return super.httpRequestWithoutBody('GET', URL_BUSSTOP).then((res) => { console.log(res) })
    }
    ...
    static buscar_bus_id() {
        let id = 1
        return super.httpRequestWithoutBody('GET', `${URL_BUS_ID}/${id}`).then((res) => { console.log(res) })
    }

    static listar_onibus() {
